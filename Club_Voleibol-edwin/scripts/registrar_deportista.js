document.addEventListener("DOMContentLoaded", () => {
  ...
  // Evitar números en tiempo real en nombres y apellidos
  const soloLetras = (e) => {
    e.target.value = e.target.value.replace(/[^A-Za-zÁÉÍÓÚáéíóúÑñ\s]/g, "");
  };

  // Evitar letras en campos numéricos en tiempo real
  const soloNumeros = (e) => {
    e.target.value = e.target.value.replace(/\D/g, "");
  };

  document.getElementById("nombres").addEventListener("input", soloLetras);
  document.getElementById("apellidos").addEventListener("input", soloLetras);
  document.getElementById("documento").addEventListener("input", soloNumeros);
  document.getElementById("telefono").addEventListener("input", soloNumeros);
  ...
  formulario.addEventListener("submit", (e) => {
    ...
    if (!/^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$/.test(jugador.nombres)) {
    ...
    if (!/^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$/.test(jugador.apellidos)) {
